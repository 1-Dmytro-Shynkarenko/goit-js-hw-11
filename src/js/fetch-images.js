...
// Асинхронна функція яка повертає проміс data і дозволяє повторно повертатись до backend без необхідності перезавантажувати сторінку складаючи шлях після базового URL із переліку ключів та номера сторінки
...
// Функція яка повертає номер сторінки до 1 після повторного запиту у пошуковій формі
function resetPages() {
    page = 1;
};